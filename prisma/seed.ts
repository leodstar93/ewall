...
const PERMISSIONS = [
  ...
  { key: "ifta:review", description: "Review synced IFTA v2 operational data" },
  { key: "ifta:approve", description: "Approve IFTA v2 filings and snapshots" },
  { key: "eld:connect", description: "Create and manage ELD provider connections" },
  { key: "eld:sync", description: "Run ELD synchronization jobs" },
