...
const defaultTemplates: TemplateDefinition[] = [
  {
    ...
    variableDescriptions: {
      inviteUrl: "The unique onboarding link the invited user must open to accept the invitation.",
      invitedByName: "The admin or team name shown as the sender of the invitation.",
      note: "The raw optional note entered by the admin when sending the invitation.",
      noteBlock: "A formatted note line. It is blank when the invitation has no admin note.",
    },
  },
  {
    ...
    variableDescriptions: {
      name: "The recipient name when available, otherwise a friendly fallback.",
      temporaryPassword: "The generated one-time password the user must change after login.",
      loginUrl: "The sign-in URL for the user.",
    },
  },
  {
    ...
    variableDescriptions: {
      name: "The recipient name when available, otherwise a friendly fallback.",
      temporaryPassword: "The generated password for email/password login.",
      loginUrl: "The sign-in URL for the user.",
    },
  },
  {
    ...
    variableDescriptions: {
      subject: "The case-specific DMV email subject generated by the workflow.",
      body: "The full case-specific DMV message generated by the workflow.",
      replyTo: "Optional reply-to email address when the workflow provides one.",
    },
  },
  {
    key: "contact_form",
    ...
    variableDescriptions: {
      name: "The name submitted in the public contact form.",
      email: "The sender email from the contact form. Also used as reply-to.",
      phone: "The submitted phone number, or a fallback when not provided.",
      message: "The message submitted in the contact form.",
    },
  },
];
...
function toView(
  ...
  return {
    ...
    variableDescriptions: definition.variableDescriptions,
