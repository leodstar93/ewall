...
async function resolveDocumentCompanyName(
  userId: string,
  db: Awaited<ReturnType<typeof buildSandboxActingUserContext>>["ctx"]["db"],
) {
...
export async function POST(request: NextRequest) {
  try {
    ...
    const companyName = await resolveDocumentCompanyName(actingUserId, ctx.db);
