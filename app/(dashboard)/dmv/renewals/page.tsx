...
import DmvRenewalClientListPage from "@/features/dmv-renewals/client-list-page";

export default async function DmvRenewalsPage() {
  ...
  return <DmvRenewalClientListPage />;
}
