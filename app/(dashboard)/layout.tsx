...
function normalizeFeature(item: FeatureApiItem): FeatureLink | null {
  ...
  return {
    ...
    permission:
      typeof item.permission === "string" ? item.permission : undefined,
    ...
    const loadFeatures = async () => {
      ...
      try {
        ...
        visible.sort((left, right) => {
          ...
          const rightOrder =
            typeof right.order === "number" ? right.order : 999;
        ...
        <aside className={styles.sidebar}>
          <div className={styles.sidebarInner}>
            <div className={styles.sidebarBrand}>
              <Link href="/settings" className={styles.brandLink}>
                <Image
