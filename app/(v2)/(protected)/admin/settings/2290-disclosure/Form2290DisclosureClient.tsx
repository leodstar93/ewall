...
export default function Form2290DisclosureClient() {
  ...
  async function load() {
    try {
      ...
      const data = (await response.json().catch(() => ({}))) as {
        settings?: { authorizationText: string | null };
        error?: string;
      };
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div className={tableStyles.card}>
        <div className={tableStyles.header}>
          <div className={tableStyles.title}>Form 2290 disclosure settings</div>
        </div>
            ...
            <div style={{ padding: 20, display: "grid", gap: 16 }}>
              <label style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                ...
                <textarea
                  ...
                  rows={8}
                  placeholder="Enter the legal disclosure statement shown to clients before they submit their Form 2290 filing..."
