  ...
  if (!role) {
    return (
      <div className={tableStyles.card} style={{ padding: 24, textAlign: "center" }}>
        ...
        <Link href="/admin/roles" style={{ color: "var(--r)", fontSize: 13, marginTop: 8, display: "inline-block" }}>
          ← Back to Roles
        </Link>
      </div>
    );
    ...
    <div className="w-full min-w-0 space-y-4">
      ...
      <div className={tableStyles.card}>
        <div className={tableStyles.header}>
          <div>
            <Link href="/admin/roles" style={{ fontSize: 12, color: "var(--r)", textDecoration: "none" }}>
              ← Back to Roles
            </Link>
