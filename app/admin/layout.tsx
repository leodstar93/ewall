...
function titleFromPath(pathname: string | null) {
  ...
  if (pathname.startsWith("/admin/settings/security/financial-access")) return "Financial Access";
  ...
  if (pathname.startsWith("/dashboard/ifta-v2/")) return "IFTA Filing Review";
  ...
  return fallbackTitleFromPath(pathname, "Admin");
}
